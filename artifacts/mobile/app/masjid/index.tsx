...
export default function MasjidScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['bottom']}>
      {/* Map */}
      {embeddedMapEnabled && MapComponent && MarkerComponent && (
        <MapComponent
          style={styles.map}
      ...
      {Platform.OS === 'android' && !androidMapsConfigured && (
        <View style={[styles.errorRow, { backgroundColor: colors.card }]}>
          <Text style={[styles.errorText, { color: colors.foreground }]}>
            The in-app map is unavailable. You can still browse nearby mosques and open directions in your maps app.
          </Text>
          <TouchableOpacity onPress={searchInGoogleMaps}>
            <Text style={{ color: colors.primary }}>Open Google Maps</Text>
          </TouchableOpacity>
        </View>
      )}
