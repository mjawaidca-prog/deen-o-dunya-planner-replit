...
export const qaidaLessons: QaidaLesson[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    subtitleEn: 'Double Fatha (-an)',
    subtitleUr: 'تنوین فتحہ – دوہری زبر',
    descriptionEn: 'Tanween Fatha (ـً) adds an "an" sound to the end of a word. Pronounced with a nasal "n".',
    descriptionUr: 'تنوین فتحہ (ـً) کلمے کے آخر میں "اَن" کی آواز بناتی ہے۔',
    gridColumns: 4,
    hasAudio: false,
    items: [
      { id:'L6_I001', text:'بً', transliteration:'Ban', audioFileName:'l6_ban.mp3', descriptionEn:'Baa with Tanween Fatha – "ban"', descriptionUr:'بً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I002', text:'تً', transliteration:'Tan', audioFileName:'l6_tan.mp3', descriptionEn:'Taa with Tanween Fatha – "tan"', descriptionUr:'تً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I003', text:'ثً', transliteration:'Than',audioFileName:'l6_than.mp3',descriptionEn:'Thaa with Tanween Fatha – "than"',descriptionUr:'ثً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I004', text:'جً', transliteration:'Jan', audioFileName:'l6_jan.mp3', descriptionEn:'Jeem with Tanween Fatha – "jan"', descriptionUr:'جً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I005', text:'حً', transliteration:'Han', audioFileName:'l6_han.mp3', descriptionEn:'Haa with Tanween Fatha – "han"',  descriptionUr:'حً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I006', text:'خً', transliteration:'Khan',audioFileName:'l6_khan.mp3',descriptionEn:'Khaa with Tanween Fatha – "khan"',descriptionUr:'خً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I007', text:'دً', transliteration:'Dan', audioFileName:'l6_dan.mp3', descriptionEn:'Daal with Tanween Fatha – "dan"', descriptionUr:'دً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I008', text:'ذً', transliteration:'Dhan',audioFileName:'l6_dhan.mp3',descriptionEn:'Dhaal with Tanween Fatha – "dhan"',descriptionUr:'ذً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I009', text:'رً', transliteration:'Ran', audioFileName:'l6_ran.mp3', descriptionEn:'Raa with Tanween Fatha – "ran"',  descriptionUr:'رً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
      { id:'L6_I010', text:'زً', transliteration:'Zan', audioFileName:'l6_zan.mp3', descriptionEn:'Zaay with Tanween Fatha – "zan"', descriptionUr:'زً – تنوین فتحہ', tajweedRule:TajweedRule.GUNNAH, isCompound:false },
    ],
  },
